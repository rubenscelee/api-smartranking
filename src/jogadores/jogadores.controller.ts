...
export class JogadoresController {
  ...
  @UsePipes(ValidationPipe)
  @ApiBody({ type: JogadorDto})
  async atualizarJogador(@Body() AtualizarJogadorDto: AtualizarJogadorDto, @Param('_id', ValidacaoParametrosPipe) id: string): Promise<Jogador>{
  ...
  @Get('/:_id')
  async consultarJogadorId(@Param('_id', ValidacaoParametrosPipe) id: string): Promise<Jogador>{
